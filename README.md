...
* Add possibility to have more than one program per user
...
* JavaScript - Used to display displayed the componets from Materialize CSS and to animate the Indez form slider.
...
* The Javascrip files viladated with [JSHint](https://jshint.com/) - No Errors found
* Python code files validaded with [PEP 8 online](http://pep8online.com/) - No Errors found
...
2. On your Heroku account, create a new app with the desired name.
3. On the 'Deployment Method' section of Heroku, link your GitHub profile and repository.
4. On the Config Vars section in the Settings tab, add the relevant key/value information from my env.py (IP, PORT, MONGO_URI, MONGO_DBNAME, SECRET_KEY).
5. On the "Deploy" tab. select Master Branch under "Choose a branch to deploy" and click "Enable Automatic Deploys".
7. Once de deployment is finished, clicked "View" to launch the app and see it on your browser.
8. All new Pushs to your Github repository will be automatically deployed on Heroku.
